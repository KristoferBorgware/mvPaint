...
//
//   npx tsx text/polygon/selfTest.ts
...
function assert(cond: boolean, msg: string): void {
  count++
  if (!cond) throw new Error(`[polygon-atlas] self-test FAILED: ${msg}`)
}
...
// --- the document the generator writes ---
{
...
// --- what the engine reads back is what a live parse would have produced ---
//
...
// --- the committed atlases are the ones this tool produces ---
{
...
console.log(`[polygon-atlas] self-test passed (${count} assertions)`)
