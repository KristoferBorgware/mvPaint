...
// --- SVG lengths: absolute units convert, relative ones have no size of their own ---
{
...
// --- the viewBox, when there is one to read ---
{
...
// --- resolving the size to rasterize at ---
{
...
// --- writing the size back into the markup ---
{
