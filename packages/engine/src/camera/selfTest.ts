...
// --- the default camera: world (0,0) at the top-left corner, one unit per pixel ---------
//
...
// --- zoom is pixels per world unit, anchored at the same top-left corner ---
{
...
// --- x/y move the view: the camera's own position is the world at the corner ---
{
...
// --- rotation turns what you see counter-clockwise, about the view centre ---
{
  const camera = new Camera2D()
...
// --- screen <-> world round-trips, which is what picking and dragging rely on ---
{
  for (const camera of [
    new Camera2D(),
...
// --- pan and zoom keep the grabbed world point under the pointer ---
//
...
// --- a degenerate zoom cannot produce a degenerate matrix ---
{
...
// --- the camera is not in the scene, and holds no reference to it ---
{
  const camera = new Camera2D()
...
// --- world points sit on the Z=0 plane the 2D scene lives in ---
{
