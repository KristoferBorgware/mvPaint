...
function assert(cond: boolean, msg: string): void {
  count++
  if (!cond) throw new Error(`[ttf] self-test FAILED: ${msg}`)
}
...
// --- kerning comes from GPOS, which needs the positioning engine initialized ---
{
...
// --- cached glyph meshes, and the same geometry the polygon atlas ships ---
{
...
// --- a book resolves styles, synthesizing what it was not given ---
{
...
// --- a curve tolerance that is coarser produces fewer points, and is honoured per book ---
{
...
// --- a buffer that is not a font is rejected, rather than half-parsed ---
{
  let rejected = false
  try {
...
console.log(`[ttf] self-test passed (${count} assertions)`)
