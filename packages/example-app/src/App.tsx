            ...
            <Stack spacing={1.5}>
              <Stack spacing={0.5}>
                ...
                {selected.length > 0 ? (
                  ...
                  <Typography variant="caption" color="text.secondary">
                    Nothing selected - click a shape, or drag a box around several (shift adds).
                  </Typography>
                )}
              </Stack>
              ...
              <Typography variant="caption" color="text.secondary">
                ...
                Ctrl-drag to pan (or middle-drag, or space+drag). Scroll or pinch to zoom, Escape to deselect.
              </Typography>
            </Stack>
          </Paper>
        </Collapse>
